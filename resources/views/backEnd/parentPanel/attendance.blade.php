                        ...
                        <div role="tabpanel" class="tab-pane fade  @if($key== 0) active show @endif" id="tab{{$key}}">
                            <div class="row">
                                <div class="col-lg-12 d-flex justify-content-between my-3">
                                    ...
                                    <a href="{{route('my_child_attendance_print', [$record->student_id,$record->id,$month, $year])}}" class="primary-btn small fix-gr-bg " target="_blank"><i class="ti-printer"> </i> @lang('common.print')</a>
                                </div>
