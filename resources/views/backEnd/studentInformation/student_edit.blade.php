                ...
                <div class="white-box">
                    <div class="">
                        ...
                        <div class="row mb-20">
                            ...
                            <div class="col-lg-3">
                                <div class="input-effect">
                                    <input class="primary-input" type="text" name="student_uid" value="{{$student->student_uid}}">
                                    <label>@lang('student.student_uid') @if(is_required('student_uid')==true) <span> *</span> @endif</label>
                                    <span class="focus-border"></span>
                                </div>
                                </div>
                        </div>
                    ...
                    <div class="row mb-20">      
                      ...
                      <div class="col-lg-3">
                            <div class="input-effect">
                             <input class="primary-input" type="text" name="psc_roll" value="{{$student->psc_roll}}">
                              <label>@lang('student.psc_roll') @if(is_required('psc_roll')==true) <span> *</span> @endif</label>
                               <span class="focus-border"></span>
                            </div>
                        ...
                        <div class="col-lg-3">
                            <div class="input-effect">
                             <input class="primary-input" type="text" name="psc_passing_year" value="{{$student->psc_passing_year}}">
                              <label>@lang('student.psc_passing_year') @if(is_required('psc_passing_year')==true) <span> *</span> @endif</label>
                               <span class="focus-border"></span>
                            </div>
                        ...
                        <div class="col-lg-3">
                            <div class="input-effect">
                             <input class="primary-input" type="text" name="psc_result" value="{{$student->psc_result}}">
                              <label>@lang('student.psc_result') @if(is_required('psc_result')==true) <span> *</span> @endif</label>
                               <span class="focus-border"></span>
                            </div>
                        ...
                        <div class="col-lg-3">
                            <div class="input-effect">
                             <input class="primary-input" type="text" name="psc_institute" value="{{$student->psc_institute}}">
                              <label>@lang('student.psc_institute') @if(is_required('psc_institute')==true) <span> *</span> @endif</label>
                               <span class="focus-border"></span>
                            </div>
                    ...
                    <div class="row mb-20">      
                        ...
                        <div class="col-lg-3">
                                <div class="input-effect">
                                    <input class="primary-input" type="text" name="jsc_roll" value="{{$student->jsc_roll}}">
                                    <label>@lang('student.jsc_roll') @if(is_required('jsc_roll')==true) <span> *</span> @endif</label>
                                    <span class="focus-border"></span>
                                </div>
                        ...
                        <div class="col-lg-3">
                                <div class="input-effect">
                                    <input class="primary-input" type="text" name="jsc_passing_year" value="{{$student->jsc_passing_year}}">
                                    <label>@lang('student.jsc_passing_year') @if(is_required('jsc_passing_year')==true) <span> *</span> @endif</label>
                                    <span class="focus-border"></span>
                                </div>
                        ...
                        <div class="col-lg-3">
                                <div class="input-effect">
                                    <input class="primary-input" type="text" name="jsc_result" value="{{$student->jsc_result}}">
                                    <label>@lang('student.jsc_result') @if(is_required('jsc_result')==true) <span> *</span> @endif</label>
                                    <span class="focus-border"></span>
                                </div>
                        ...
                        <div class="col-lg-3">
                                <div class="input-effect">
                                    <input class="primary-input" type="text" name="jsc_institute" value="{{$student->jsc_institute}}">
                                    <label>@lang('student.jsc_institute') @if(is_required('jsc_institute')==true) <span> *</span> @endif</label>
                                    <span class="focus-border"></span>
                                </div>
                        ...
                        <div class="parent_details" id="parent_details">
                            ...
                            <div class="row mb-20">
                                ...
                                <div class="no-gutters input-right-icon">
                                    <div class="col">
                                        <div class="input-effect">
                                            <input class="primary-input date form-control{{ $errors->has('fathers_date_of_birth') ? ' is-invalid' : '' }}" id="startDate" type="text" name="fathers_date_of_birth" value="{{date('m/d/Y', strtotime($student->parents->fathers_date_of_birth))}}" autocomplete="off">
                                            <span class="focus-border"></span>
                                            <label>@lang('fathers_date_of_birth') @if(is_required('fathers_date_of_birth')==true) <span> *</span> @endif</label>
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect">
                                        <input class="primary-input form-control" type="text" placeholder="" name="fathers_nid" id="fathers_nid" value="{{@$student->parents->fathers_nid}}">
                            ...
                            <div class="row mb-20">
                                ...
                                <div class="col-lg-2">
                                    <div class="input-effect">
                                        <input class="primary-input" type="text" name="mothers_nid" id="mothers_nid" value="{{@$student->parents->mothers_nid}}">
                                        <label>@lang('student.mothers_nid') @if(is_required('mothers_nid')==true) <span> *</span> @endif</label>
                                        <span class="focus-border"></span>
                                    </div>
                                </div>
                            ...
                            <div class="row mb-20">
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect">
                                        <input class="primary-input" type="text" name="guardians_nid" id="guardians_nid" value="{{@$student->parents->guardians_nid}}">
                                        <label>@lang('student.guardians_nid') @if(is_required('guardians_nid')==true) <span> *</span> @endif</label>
                                        <span class="focus-border"></span>
                                    </div>
                                </div>
